...
module OpenRubyRMK
  class Karfunkel
    ...
    #for establishing a plugin structure. This module is used by the Karfunkel
    #class to define some methods as "hooks" which you can override inside
    #a plugin module which then is mixed into Karfunkel.
    #
    #==Example
    ...
    #your +Machine+ class’ #procude method pluggable, it will work:
    #
    #  class Machine
    #    extend Pluggable
    #    
