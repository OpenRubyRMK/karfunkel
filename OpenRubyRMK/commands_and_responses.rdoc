...
This is the basic structure of a request you send to Karfunkel (exception is the +Hello+ request which misses the <id> tag at the toplevel as you don't have an ID at that moment): 
  ...
  <Karfunkel> #This is the root. It's ALWAYS <Karfunkel>. Capitalized. 
    <id>6</id> #The ID of the client speaking. You get your ID via the HELLO request, use that one here.
...
Whenever you send a request to Karfunkel, he responds in some way. His responses always have the following structure: 
  ...
  <Karfunkel> #As always. This is the root. 
    <id>0</id> #The ID of the speaker--0 is Karfunkel's own ID. 
...
Establishes a connection. Send this command immediately after you have connected to Karfunkel. 
  ...
  <Karfunkel>
    #Don't put the <id> tag here--you don't have an ID yet!
...
=====OK: 
  ...
  <Karfunkel>
    ...
    <response type="Hello" id="0"> #The request ID is still 0
      ...
      <my_clients_num>NUMBER_OF_CLIENTS</my_clients_num> #The number of clients up till now--this excludes you for the moment. 
    </response>
  </Karfunkel>
