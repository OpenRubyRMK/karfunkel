...
OpenRubyRMK::Karfunkel::SM::Request.define :Hello do
  ...
  execute do |client|
    answer client, :reject, :reason => "Already authenticated!" and return if client.authenticated?
    ...
    answer client, :ok, :id => client.id, :my_version => OpenRubyRMK::VERSION, :my_project => Karfunkel.selected_project.to_s, :my_clients_num => Karfunkel.clients.count
  end
